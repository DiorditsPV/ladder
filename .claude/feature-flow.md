...
- **Блок «Сценарий использования»** — каждая issue, помимо тех-описания, несёт раздел `## Сценарий использования` (**Кто · Зачем · Сценарий · Почему так**): под какой пользовательский кейс делается фича. Без него issue не груммится.
