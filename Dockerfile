...
# (см. deploy/interview.service), чтобы локальный контейнер и прод не разъезжались.
...
# Ровно те три переменные, что выставляет systemd-юнит deploy/interview.service.
